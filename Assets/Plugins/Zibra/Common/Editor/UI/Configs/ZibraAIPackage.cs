...
namespace com.zibra.liquid
{
    internal static class ZibraAIPackage
    {
        ...
        internal const string DisplayName = "Zibra Effects";

        internal static readonly string RootPath = "Assets/Plugins/Zibra";

        internal static readonly string WindowTabsPath = $"{RootPath}/Common/Editor/UI/Window/Tabs";

        internal static readonly string UIToolkitPath = $"{RootPath}/Common/Editor/UI/UIToolkit";
        internal static readonly string UIToolkitControlsPath = $"{UIToolkitPath}/Controls";

        internal static readonly string EditorArtAssetsPath = $"{RootPath}/Common/Editor/UI/Art";
